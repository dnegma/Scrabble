...
public class BonusSquareAndBalancePenaltyAndHighScoreRound extends Player {
	...
	public BonusSquareAndBalancePenaltyAndHighScoreRound(Board board) {
		super(board);
		initVowels();
	}
	...
	public String getName() {
		...
		String ratio = BonusSquareAndBalancePenaltyAndHighScoreRound.VOWELS + "of"
