...
Each of the agents has been tested against the other to, to let us evaluate the impact of each strategy. Explanations of the agents can be read about in section \ref{sec:agents}.

\graphicspath{{../results/Plots/}}
\subsection{High score words vs Balance on rack}
\begin{figure}
\centering
\includegraphics[scale=0.5]{High_Balance2pen2vow_1000games}
