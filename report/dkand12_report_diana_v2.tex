...
Each of the agents has been tested against the other to, to let us evaluate the impact of each strategy. Explanations of the agents can be read about in section \ref{sec:agents}. The agents were set to play 1000 games against each other and to minimize the impact of opening the game in the results, both agents started the game 500 times.
...
The results from the games played by HSW and BOR show that the ability to lay words with high score letters is more rewarding than keeping the balance on the rack.
\begin{figure}
\centering
\includegraphics[scale=0.5]{High_BalanceOnly2pen2vow_1000games}
\caption {Scores. Scores of the two players in 1000 games.}
\label{fig:anchors}
\end{figure}
