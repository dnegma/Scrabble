...
The agents were set to play 1000 games against each other and to minimize the impact of opening the game in the results, both agents started the game 500 times.

Two dicionaries were used in the tests; one consisting of only the normal form of each word and the other consisting of all possible forms of each words, where the latter is a set of 480391 words. The former consists of 83247 words. The rules of Swedish Scrabble do not allow words of all forms, but the english does. Therefore, it seemed interesting to compare how the agents would perform with different conditions.

\graphicspath{{../results/Plots/}}
\subsection{High score words vs Balance on rack}

The BOR player uses a ratio between vowels and consonants on the rack, and strives to keep the ratio after each move. Several tests were made with the BOR player to see if there is any difference when altering the ratio parameter. The ratio is calculated as the number of vowels left on hand divided into the number of consonants left on hand. Table \ref{tab:bor+hsw} shows the results of the runs made with different ideal number of vowels on hand.

An interesting result is the one when the ideal ratio of vowels are 1, i.e. when all tiles should be vowels.

\begin{table}
\centering
    \begin{tabular}{ | l | l | l | p{5cm} |}
    \hline
   	Vowels & HSW & BOR \\ \hline
	0 & 995 & 4 \\ \hline
    	1 & 1000 & 0  \\ \hline
    	2 & 954 + 958 + 949 & 46 + 42 + 51 \\ \hline
    	3 & 979 & 20 \\ \hline
	4 & 975 & 25 \\ \hline
	5 & 960 & 38 \\ \hline
	6 & 915 & 83 \\ \hline
	...
	8 & 866 & 132 \\ \hline
    \end{tabular}
\caption{Winnings. Amount of winning games of a total of 1000 games over 10 runs.} 
\label{tab:bor+hsw}
\end{table}
...
\caption {Scores. Scores of the two players in 1000 games with 480 391 words available.}
\label{fig:highbalance}
\end {figure}

\begin{figure}
\centering
\includegraphics[scale=0.5]{High_Balance2pen2vow_1000games_smallDict}
\caption {Scores. Scores of the two players in 1000 games with 83 247 words available.}
\label{fig:highbalance}
\end{figure}

Testing parameters:
\begin{itemize}
\item Balance 1: 5 vowels of 8
\item Balance 2: 3 vowels of 8
\end{itemize}
